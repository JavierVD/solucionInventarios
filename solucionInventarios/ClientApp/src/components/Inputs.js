...
export default function Inputs() {
    ...
    const executeEntries = async () => {
        items.map((e, idx) => {
            ...
            axios.put('http://localhost:5183/api/articulo/' + e.id + '/stock', JSON.stringify({ newStock: parseInt(e.count) }), {
                headers: {
                    'Content-Type': 'application/json'
                }
            })
    ...
    return (
        <div className="main-div">
            <div className="static-header">
                <span className="home-text">Entradas</span>
            </div>
            ...
            <div className = "top-container">
                ...
                <div>
                    <Button onClick={() => { executeEntries() }} color="primary" className= "execute-button">Confirmar entradas  <img width = "20px" src = "./img/cheque.png"/></Button>
                </div>
            </div>
